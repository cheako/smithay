...
pub struct Device {
    ...
    pub logical: vk::Device,
    pub displays: RefCell<HashMap<u64, Rc<Display>>>,
    pub programs: (vk::ShaderModule, Vec<vk::ShaderModule>),
    pub descriptors: (vk::DescriptorPool, [vk::DescriptorSetLayout; 2]),
    pub pipeline: (vk::PipelineCache, vk::PipelineLayout),
    pub allocator: Rc<vk_mem::Allocator>,
    // family_index: QueueFamilyIndex,
    pub graphics: (u32, vk::Queue, vk::CommandPool, vk::CommandBuffer),
    pub transfer: Option<(vk::Queue, vk::CommandPool, vk::CommandBuffer)>,
    pub presentations: Vec<(u32, vk::Queue)>,
...
fn find_queue_family_index(physical_device: vk::PhysicalDevice) -> Result<QueueFamilyIndices, ()> {
